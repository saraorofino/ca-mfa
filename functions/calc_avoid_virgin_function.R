...
#' @return If summary 'FALSE' a detailed data frame called 'avoid_virgin' with columns for year, sector, metric megatons of avoided virgin plastic 'mt_avoid_virgin' compared to business as usual and metric megatons of virgin plastic after recycled content targets 'mt_plastic_virgin'. 
...
avoid_virgin_function <- function(consum_bau,consum_byo, rc_perc_byo, ca_scrap_consump, summary = FALSE) {
  avoid_virgin <- consum_total_byo %>%
